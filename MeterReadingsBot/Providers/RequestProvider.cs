namespace MeterReadingsBot.Providers
{
    ...
    public class RequestProvider : IRequestProvider
    {
        public (Uri,StringContent) SendReadings(int personalNumber, int hot)
        {
            ...
            var content = new StringContent($"nomer={personalNumber}&0={hot}", Encoding.UTF8, "application/x-www-form-urlencoded");
            return (uri, content);
        }
        ...
        public (Uri,StringContent) GetInformation(int personalNumber)
        {
            ...
            var content = new StringContent($"nomer={personalNumber}", Encoding.UTF8, "application/x-www-form-urlencoded");
            return (uri, content);
        }
    }
}
